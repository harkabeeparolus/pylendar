...
The codebase is intentionally a single file (`src/pylendar/pylendar.py`, ~500 lines) so it can be used as a standalone script via PEP 723 inline script metadata. Three main components:
